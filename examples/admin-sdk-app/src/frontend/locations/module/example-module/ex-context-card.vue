...
import { context, notification } from '@allincart-ag/meteor-admin-sdk';
import { SwCard, SwButton } from '@allincart-ag/meteor-component-library';
...
async function getCurrentShopwareVersion() {
  const currentShopwareVersion = await context.getAllincartVersion();
