...
import { notification, context, data, window } from '@allincart-ag/meteor-admin-sdk';
import { SwButton, SwTextField, SwTextarea } from '@allincart-ag/meteor-component-library';
    ...
    template: `
        <div style="padding: 20px;">
            ...
            <div>
                ...
                <sw-button @click="getAllincartVersion">Get current Shopware version</sw-button>
            ...
            routeInformation:  `
{
    ...
    methods: {
        ...
        async getAllincartVersion() {
            this.shopwareVersion = await context.getAllincartVersion();
        },
