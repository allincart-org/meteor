  ...
  messages: {
    en: {
      "mt-field-error": {
        ...
        ALLINCART_INVALID_IP: "Please enter a valid IP address.",
    ...
    zh: {
      "mt-field-error": {
        ...
        "INVALID_MEDIA_URL": "请输入有效的 URL 来上传文件。",
        "CONTENT__MISSING_RULE_TYPE_EXCEPTION": "你必须为该规则选择一个类型。",
        "CONTENT__INVALID_CATEGORY_TYPE_AS_ENTRY_POINT": "当该分类被设为入口点时，不能选择此类型。",
        "ALLINCART_INVALID_IP": "请输入有效的 IP 地址。",
