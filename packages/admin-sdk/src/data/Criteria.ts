...
export default class Criteria {
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Query\ScoreQuery.
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\AvgAggregation
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\CountAggregation
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\MaxAggregation
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\MinAggregation
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\StatsAggregation
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\SumAggregation
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Aggregation\Bucket\TermsAggregation
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\EntityAggregation
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Aggregation\Bucket\FilterAggregation
   * Allows to filter an aggregation result
   */
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Aggregation\Bucket\DateHistogramAggregation
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Sorting\FieldSorting.
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Sorting\CountSorting.
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Filter\ContainsFilter.
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Filter\PrefixFilter.
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Filter\SuffixFilter.
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Filter\EqualsAnyFilter.
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Filter\RangeFilter.
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Filter\EqualsFilter.
   * This allows to filter documents where the field matches a defined range
   *
  ...
  /**
   * @see \Allincart\Core\Framework\DataAbstractionLayer\Search\Filter\NotFilter.
